...
import { AuthScope } from '../../../../../cs-lib/src/lib/constants';

export class AuthScopeInformation {
  public constructor(
    public relyingParty = '',
    public scope = '',
    public scopeValue = '',
    public issueCompressToken = false
  ) {
    switch (scope) {
      case 'AppInstance': this.scope = AuthScope.AppInstance;
        break;
      case 'Unscope': this.scope = AuthScope.Unscope;
        break;
      default: this.scope = AuthScope.Tenant;
        break;
    }
  }
}
