...
import { ICsopSettings } from '../interfaces/csop-settings.interface';
import { IAppSettings } from '../interfaces/app-settings-interface';
import { IAuthProviders } from '../interfaces/authproviders.interface';

export class CsopSettings implements ICsopSettings {
  public applications: Array<IAppSettings>;
  public authProviders: Array<IAuthProviders>;
