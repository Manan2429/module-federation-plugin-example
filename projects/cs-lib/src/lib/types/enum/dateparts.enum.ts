...
export enum DateTimePartsInNumber {
    NumberOfMonthInYear = 12,
    NumberOfDaysInMonth = 30,
    NumberOfMiliSecondInDays = 86400000,
    NumberOfMiliSecondInHour = 3600000,
    NumberOfMiliSecondInMinutes = 60000,
}
