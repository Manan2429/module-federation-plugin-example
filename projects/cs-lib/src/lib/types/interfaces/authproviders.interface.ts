...
export interface IAuthProviders {
  ...
  clientID: string;  //// CSOP application Id which is register into Azure AD.
  endPoint: string;
  microsoftGraphApiEndpoint: string;
  microsoftGraphApiScope: string[];
  name: string;
  tenantId: string; //// Azure AD Id
}
