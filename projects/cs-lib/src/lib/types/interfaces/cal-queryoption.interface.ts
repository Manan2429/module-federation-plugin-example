...
/* Unpublished © 2022 Allscripts Healthcare, LLC and/or its affiliates. All Rights
Reserved.
*
...
import { IFilterOption } from './cal-filteroption.interface';
import { IPagingOption } from './cal-paging.interface';

export interface IQueryOption {
  AdopterId: number;
  AdopterInstances?: string;
  AdopterType: number;
  FieldOptions: string;
  FilterOptions: IFilterOption[];
  QueryPagingOptions: IPagingOption;
}
