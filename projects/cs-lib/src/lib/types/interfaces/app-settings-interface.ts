...
import { IApiURL } from './apiurl.interface';
import { IAuthenticationMechanism } from './authentication-mechanism-interface';
import { IRole } from './role.interface';

/* P r o p r i e t a r y N o t i c e */
export interface IAppSettings {
  apiURLs: Array<IApiURL>;
  applicationId: string;
  appModulePath: string;
  appName: string;
  appTitle: string;
  appVersion: string;
  authenticationMechanism: IAuthenticationMechanism;
  defaultNavigationPath: string;
  permissions: Array<IRole>;
