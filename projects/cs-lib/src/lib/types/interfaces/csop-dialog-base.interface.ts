...
import { ICsopDialogCloseContent } from '../interfaces/csop-dialog-close-content.interface';

export interface ICsopDialogBase {
  data?: any; // tslint:disable-line: no-any
  dialogClosed: EventEmitter<ICsopDialogCloseContent>;
