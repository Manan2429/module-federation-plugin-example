...
import { ICsopAlertMessage } from './csop-alert-message.interface';

export interface ICsopInlineAlertMessage extends ICsopAlertMessage {
  // sub-message to be displayed on alert
  subMessage: string;
}
